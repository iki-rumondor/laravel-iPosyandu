                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn-delete btn btn-sm btn-danger animate-up-3" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal" data-id="{{ $schedule->id }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input name="date" id="date" data-datepicker=""
                                    class="form-control datepicker-input" id="schedule" type="text"
                                    placeholder="Bulan/Tanggal/Tahun" required>
                                <div class="datepicker datepicker-dropdown datepicker-orient-left datepicker-orient-bottom"
                                    style="left: 1398.97px; top: 304.172px;">
                                    <div class="datepicker-picker">
                                        <div class="datepicker-header">
